...
def parse_args():
    ...
    a("--iterations", type=int, default=450000, help="Number of training steps")
    ...
    a("--input", default="s", help="Definition of the input of the network")
    ...
    a("--noise", type=float, default=1e-2, help="Amount of noise to introduce in the estimate.")
